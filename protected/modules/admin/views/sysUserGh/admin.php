		...
		*/
			...
			'buttons'=>array(
				...
				'switch'=>array(
					...
					'url'=>'Yii::app()->getController()->createUrl("sysUserGh/switch", array("ghid"=>$data->ghid))'
				), 
				'open'=>array(
					'title'=>'', 
					'label'=>'<i class="glyph-icon icon-cogs"></i>插件开通', 
					'options'=>array(
						'class'=>'ext-cbtn'
					), 
					'url'=>'Yii::app()->getController()->createUrl("plugin/openPlugn", array("ghid_control"=>$data->ghid))'
				)
			)
