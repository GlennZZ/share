...
$('.search-form form').submit(function(){
	$('#sys-slide-img-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div id="page-content">
	...
	<a href="<?php echo $this->createUrl('/admin/SysSlide/admin');?>" class="btn medium primary-bg">
            <span class="button-content">
                <i class="glyph-icon icon-mail-reply-all float-left"></i>
              返回
            </span>
        </a>
		<a href="<?php echo $this->createUrl('create',array('sid'=>$_GET['sid']));?>" class="btn medium primary-bg ">
			<span class="button-content">
