...
<div class="button-pane text-center">
		<button onclick="return $('#prize-log-form').parsley( 'validate' );" type="submit" class="btn medium primary-bg text-transform-upr font-size-11" id="demo-form-valid" title="Validate!">
