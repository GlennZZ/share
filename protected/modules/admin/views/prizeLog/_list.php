...
<td><?php echo CHtml::encode($data->id); ?></td><td><?php echo CHtml::encode($data->uid); ?></td><td><?php echo CHtml::encode($data->unid); ?></td><td><?php echo CHtml::encode($data->name); ?></td><td><?php echo CHtml::encode($data->pid); ?></td><td><?php echo CHtml::encode($data->create_time); ?></td>
	<td>
		<div class="dropdown">
