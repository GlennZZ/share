...
<div id="page-content">
	...
	<div style="padding-bottom: 10px">
		<a href="<?php echo $this->createUrl('/admin/AppGame/admin');?>?category=1" class="btn medium primary-bg ">
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
			'name'=>'用户',
			'value'=>'CHtml::image($data->wxuser->headimgurl?$data->wxuser->headimgurl:"http://res1.i-lz.cn/static/images/wicon.jpg","",
					array(
					"height"=>150,
				    "style"=>"cursor: -webkit-zoom-in;height: 40px;border-radius: 100%!important;float:left;  border: 1px solid #D0D0D0;",
					"class"=>"medium radius-all-2",
				    "onclick"=>"image_priview($(this).attr(\"src\"))"
					)
				)."<div style=\'margin-top: 13px;\'>".$data->wxuser->nickname."</div>"',  // 这里显示图片
			'type'=>'raw',  // 这里是原型输出
			'htmlOptions'=>array(
				'width'=>'200',
		...
		//'type',
		//'integral',
		array('name'=>'消耗积分','value'=>'$data->integral'),
		'note',
		//'aid',
