...
/**
 * This is the model class for table "sys_member_share".
 *
 * The followings are the available columns in table 'sys_member_share':
 * @property integer $id
 ...
 * @property string $utm
 */
class SysMemberShare extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('uid, aid,integral', 'numerical', 'integerOnly'=>true),
	 ...
	 * @return SysMemberShare the static model class
	 */
